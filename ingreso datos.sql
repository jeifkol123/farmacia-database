...
SELECT 1, 1, 1, 'Ácido acetilsalicílico', 1.50, 2.00,'05/06/2024', 1400 FROM dual UNION ALL
SELECT 2, 2, 1, 'Paracetamol', 1.72, 2.15,'05/04/2025', 2300 FROM dual UNION ALL
SELECT 3, 3, 1, 'Atropina', 2.45, 4.54,'08/08/2026', 8700 FROM dual UNION ALL
SELECT 4, 4, 1,'Lidocaína' , 4.5, 5.01, '07/08/2024', 5200 FROM dual UNION ALL
SELECT 5, 5, 1, 'Propranolol', 3.4, 4.1, '03/06/2025', 2700 FROM dual UNION ALL
SELECT 6, 6, 1, 'Digoxina', 5.67, 6.7,'02/05/2024', 3300 FROM dual UNION ALL
